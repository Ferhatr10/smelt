...
1.  **Modeling (Daml)**: Define templates, choices, and data types. Use [smart-contracts.md](file:///Users/alitap/DEV/smelt/.agents/skills/canton-app-builder/references/smart-contracts.md) for language reference.
...
4.  **Integration (Ledger API)**: Connect your frontend/backend via JSON API V2 or gRPC. Use [app-development.md](file:///Users/alitap/DEV/smelt/.agents/skills/canton-app-builder/references/app-development.md).
5.  **Deployment (Canton)**: Deploy nodes, allocate parties, and manage upgrades. Use [operations-and-sdlc.md](file:///Users/alitap/DEV/smelt/.agents/skills/canton-app-builder/references/operations-and-sdlc.md).
...
*Full details in [smart-contracts.md](file:///Users/alitap/DEV/smelt/.agents/skills/canton-app-builder/references/smart-contracts.md)*
...
*Full details in [app-development.md](file:///Users/alitap/DEV/smelt/.agents/skills/canton-app-builder/references/app-development.md)*
...
### 4. Operations & SDLC
*Full details in [operations-and-sdlc.md](file:///Users/alitap/DEV/smelt/.agents/skills/canton-app-builder/references/operations-and-sdlc.md)*
