...
var require_util = __commonJS({
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/core/util.js"(exports2, module2) {
    ...
    function isDestroyed(body) {
      var _a;
      return body && !!(body.destroyed || body[kDestroyed] || ((_a = stream2.isDestroyed) == null ? void 0 : _a.call(stream2, body)));
    }
    ...
    function removeAllListeners(obj) {
      var _a;
      for (const [name, listener] of (_a = obj[kListeners]) != null ? _a : []) {
...
var require_client_h2 = __commonJS({
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/dispatcher/client-h2.js"(exports2, module2) {
    ...
    function writeH2(client, request) {
      ...
      if (util2.isFormDataLike(body)) {
        extractBody != null ? extractBody : extractBody = require_body().extractBody;
        const [bodyStream, contentType] = extractBody(body);
      ...
      stream2.once("end", () => {
        var _a;
        if (((_a = stream2.state) == null ? void 0 : _a.state) == null || stream2.state.state < 6) {
          request.onComplete([]);
        }
...
var require_env_http_proxy_agent = __commonJS({
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/dispatcher/env-http-proxy-agent.js"(exports2, module2) {
    ...
    parseNoProxy_fn = function() {
      var _a;
      const noProxyValue = (_a = __privateGet(this, _opts).noProxy) != null ? _a : __privateGet(this, _EnvHttpProxyAgent_instances, noProxyEnv_get);
  ...
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/api/abort-signal.js"(exports2, module2) {
    ...
    function abort(self) {
      ...
      if (self.abort) {
        ...
        self.reason = (_c = (_b = self[kSignal]) == null ? void 0 : _b.reason) != null ? _c : new RequestAbortedError();
      }
      removeSignal(self);
    }
  ...
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/mock/mock-agent.js"(exports2, module2) {
    ...
    var MockAgent = class extends Dispatcher {
      constructor(opts) {
        ...
        const agent = (opts == null ? void 0 : opts.agent) ? opts.agent : new Agent3(opts);
        this[kAgent] = agent;
  ...
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/interceptor/dns.js"(exports2, module2) {
    ...
    var DNSInstance = class {
      constructor(opts) {
        ...
        this.lookup = (_a = opts.lookup) != null ? _a : __privateMethod(this, _DNSInstance_instances, defaultLookup_fn);
        this.pick = (_b = opts.pick) != null ? _b : __privateMethod(this, _DNSInstance_instances, defaultPick_fn);
      }
      get full() {
      ...
      setRecords(origin, addresses) {
        ...
        for (const record of addresses) {
          ...
          const familyRecords = (_a = records.records[record.family]) != null ? _a : { ips: [] };
    ...
    defaultPick_fn = function(origin, hostnameRecords, affinity) {
      ...
      ip = (_a = family.ips[position]) != null ? _a : null;
      if (ip == null) {
        return ip;
      }
    ...
    module2.exports = (interceptorOpts) => {
      ...
      const dualStack = (_a = interceptorOpts == null ? void 0 : interceptorOpts.dualStack) != null ? _a : true;
      let affinity;
      if (dualStack) {
        affinity = (_b = interceptorOpts == null ? void 0 : interceptorOpts.affinity) != null ? _b : null;
      } else {
        affinity = (_c = interceptorOpts == null ? void 0 : interceptorOpts.affinity) != null ? _c : 4;
      }
      const opts = {
        ...
        dualStack,
        affinity,
        maxItems: (_g = interceptorOpts == null ? void 0 : interceptorOpts.maxItems) != null ? _g : Infinity
      };
...
var require_fetch = __commonJS({
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/web/fetch/index.js"(exports2, module2) {
    ...
    var EE = require("events");
    var { Readable, pipeline: pipeline2, finished } = require("stream");
  ...
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/lib/web/websocket/frame.js"(exports2, module2) {
    ...
    function generateMask() {
      if (bufIdx === BUFFER_SIZE) {
        bufIdx = 0;
        crypto2.randomFillSync(buffer != null ? buffer : buffer = Buffer.allocUnsafe(BUFFER_SIZE), 0, BUFFER_SIZE);
      }
...
var require_undici = __commonJS({
  "node_modules/.pnpm/undici@6.24.1/node_modules/undici/index.js"(exports2, module2) {
    ...
    var _a;
    module2.exports.File = (_a = globalThis.File) != null ? _a : require("buffer").File;
...
var getWindowsInfo = () => __awaiter7(void 0, void 0, void 0, function* () {
...
var getLinuxInfo = () => __awaiter7(void 0, void 0, void 0, function* () {
